...
export KUBECTL_VERSION=${KUBECTL_VERSION:="1.24.7"}
...
export KIND_IMAGE=${KIND_IMAGE:="kindest/node:v1.24.7@sha256:577c630ce8e509131eab1aea12c022190978dd2f745aac5eb1fe65c0807eb315"}
